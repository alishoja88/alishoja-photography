...
# Set minimal environment variables for build process only
# Real values will be overridden at runtime by docker-compose
ENV MONGODB_URI="mongodb://build-placeholder"
ENV NEXTAUTH_URL="http://localhost:3000"
ENV NEXTAUTH_SECRET="build-secret"
ENV EMAIL_USER="build@example.com"
ENV EMAIL_APP_PASSWORD="build-password"
